...
%-------------------------------------------------------------------------------
\cventry
    {\textbf{Website Developer}} % Job title
    {Terminillo Trekking 360 \hspace{0.1cm} \raisebox{-0.3\height}{\includegraphics[width=0.8cm]{img/terminillo-logo.png}} } % Organization
    {Rieti, Italy} % Location
    {Feb. 2020 - Apr. 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Developed and maintained the website using WordPress for managing outdoor event bookings.}
        \item {Managed SEO using Google Search Console, increasing website visibility and driving more traffic.}
        \item {Increased the company’s number of bookings and customer satisfaction by streamlining the reservation process.}
      \end{cvitems}
    }
...
%-------------------------------------------------------------------------------
\cventry
  {\textbf{JA Impresa in Azione Project Member}} % Job title
  {Junior Achievement Italy\hspace{0.1cm} \raisebox{-0.3\height}{\includegraphics[width=0.8cm]{img/ja-logo.png}} } % Organization
  {Milan, Italy} % Location
  {May 2018} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Participated in a project that introduced students to business by creating a mini-enterprise.}
      \item {Developed a business plan for the enterprise, which won the National Final Award for Best Business Plan.}
    \end{cvitems}
  }
%-------------------------------------------------------------------------------
%   \cventry
